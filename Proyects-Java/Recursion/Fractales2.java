...
public class Fractales2{
    public static void main(String[] args) {
        ...
        jacinto.penColor(Color.MAGENTA);
        jacinto.jumpTo(-length * 2 / 2.0, 0);
        jerusalen.penColor(Color.CYAN);
        jerusalen.jumpTo(-length * 2 / 2.0, 0);
        manito.penColor(Color.BLACK);
        manito.jumpTo(-length * 3 / 2.0, 0);
        piecito.penColor(Color.RED);
        piecito.jumpTo(-length * 3 / 2.0, 0);
    ...
    public static void fractalitos2Xd(Turtle pablito, double length) {
        if (length < 5) {
            pablito.move(length);
            return;
        }
        length /= 3;
        fractalitos2Xd(pablito, length);
        pablito.turn(-60);
        fractalitos2Xd(pablito, length);
        pablito.turn(120);
        fractalitos2Xd(pablito, length);
