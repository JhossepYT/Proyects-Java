...
class Mensaje{
    public static void main(String[] args) {
        ...
        LetrasUPRG.letraG(pablito8, blue[1], blue[2], blue[3]);
        pablito8.jumpTo(220, -385);
        LetrasUPRG.letraR(pablito8, yellow[1], yellow[2], yellow[3]); 
        pablito8.jumpTo(282, -375);    
        N_E_C_A_S.char_A(pablito8, yellow[1], yellow[2], yellow[3]);
        ...
        M_I_T_Z.letraI(pablito8, 470, -390, 1200, green[1], green[2], green[3]);
        O_D_L_Q.letraO(pablito8, 530, -385,yellow[1], yellow[2], yellow[3]);
        pablito8.jumpTo(580, -375);
        pablito8.turn(90);    
        N_E_C_A_S.char_N(pablito8, yellow[1], yellow[2], yellow[3]);
